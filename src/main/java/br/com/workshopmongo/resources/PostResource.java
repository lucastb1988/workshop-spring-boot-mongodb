...
public class PostResource {
	...
	public ResponseEntity<List<Post>> fullSearch(
		...
		text = URL.decodeParam(text); //decodifica a string passada (se caso houver espaços no parametro ele decodifica esse espaço)
		Date min = URL.convertDate(minDate, new Date(0L)); //converte data String em Date e configura uma data minima se não houver uma (01/09/1970)
		Date max = URL.convertDate(maxDate, new Date()); //converte data String em Date e configura uma data maxima como a data de hoje do sistema
